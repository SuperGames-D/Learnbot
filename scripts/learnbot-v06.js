...
function message(message, sender) {
    ...
    if (sender == botname) {
        ...
        document.getElementById("conversation").innerHTML += "<br><button onclick=\"goodResponse(" + String(conversationAI.length-1) +")\" class=\"responseButton\"\"><img src=\"images/like.png\" style=\"transform: scaleY(1);\" width=\"15px\"></button>"
        document.getElementById("conversation").innerHTML += "<button onclick=\"badResponse()\" class=\"responseButton\"\"><img src=\"images/like.png\" style=\"transform: scaleY(-1);\" width=\"15px\"></button>"
    }
...
function goodResponse(msg) {
    document.getElementById("teach").value = conversationAI[msg] + document.getElementById("teach").value
    changeDatabase()
}