...
const removeWords = ["what", "when", "who", "why", "how", "where", "do", "often", "much", "does", "many", "it", "about", "which", "define", "tell me", "can you explain"];
...
function message(message, sender) {
    ...
    if (sender == botname) {
        ...
        document.getElementById("conversation").innerHTML += "<br><button onclick=\"goodResponse(" + String(conversationAI.length-1) +")\" class=\"responseButton\"\"><img src=\"images/like.png\" style=\"transform: scaleY(1);\" width=\"" + String(userFontSize) +"px\"></button>"
        document.getElementById("conversation").innerHTML += "<button onclick=\"badResponse()\" class=\"responseButton\"\"><img src=\"images/like.png\" style=\"transform: scaleY(-1);\" width=\"" + String(userFontSize) +"px\"></button>"
    }
